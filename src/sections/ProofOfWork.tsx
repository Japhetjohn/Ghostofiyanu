...
const stages: ProjectStage[] = [
  {
    ...
    role: 'Marketing & Community Manager', org: '/Send Fintech', period: '2023 — 2024',
    achievements: ['Led community engagement campaigns for a fintech payments platform', 'Hosted multiple X Spaces and online educational events', 'Built ambassador initiatives with crypto influencers', 'Drove brand trust and user adoption through strategic content'],
    icon: '01', metrics: [{ label: 'Spaces Hosted', value: '15+' }, { label: 'Engagement', value: '10K+' }],
  },
  {
    id: 2, title: 'KNOWLEDGE HUB', subtitle: 'Education First',
    role: 'Community Manager & Contributor', org: 'Academia.Edu', period: '2023 — 2024',
    achievements: ['Managed a learning-focused crypto community for students', 'Organized Q&A sessions, AMAs, and weekly study groups', 'Supported growth campaigns within university circles', 'Improved retention through educational content series'],
    icon: '02', metrics: [{ label: 'Students', value: '500+' }, { label: 'Sessions', value: '40+' }],
  },
  {
    id: 3, title: 'INNOVATION CORE', subtitle: 'Leading the Future',
    role: 'Core Lead — ORBIT Program', org: 'Ilorin Innovation Hub', period: '2024 — Present',
    achievements: ['Led ORBIT program increasing Web3 and Web2 awareness', 'Bridged technology solutions for local innovators', 'Organized community events, hackathons, and tech workshops', 'Managed partnerships with IHS Towers, CcHub, and Future Africa'],
    icon: '03', metrics: [{ label: 'Interns Led', value: '50+' }, { label: 'Partners', value: '4' }],
  },
  {
    id: 4, title: 'REAL WORLD IMPACT', subtitle: 'From Screen to Street',
    role: 'Event Organizer & Onboarding Lead', org: 'Various Projects', period: '2023 — 2024',
    achievements: ['Organized 2 large-scale events with 500+ attendees each', 'Onboarded 200+ individuals to fintech apps via IRL activations', 'Led in-person adoption campaigns connecting product to people', 'Built lasting relationships between digital products and communities'],
    icon: '04', metrics: [{ label: 'Attendees', value: '1000+' }, { label: 'Onboarded', value: '200+' }],
  },
  {
    ...
    achievements: ['Built @ghostofiyanu presence with 3K+ engaged followers', 'Hosted regular X Spaces on Web3 trends and community building', 'Created educational content driving fintech adoption in Africa', 'Established thought leadership in the Nigerian Web3 space'],
  ...
  },
  {
    ...
    achievements: ['Developed go-to-market strategies for emerging Web3 projects', 'Managed KOL partnerships and influencer marketing campaigns', 'Advised on community tokenomics and governance structures', 'Connected projects with strategic collaborators and investors'],
